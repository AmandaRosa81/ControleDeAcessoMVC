...
public class HorarioPadraoController {
    ...
    public String cadastrarHorarioPadrao(int idProfessor, String diaSemana, LocalTime horaInicio, LocalTime horaFim, String tipo) {
        HorarioPadrao horario = new HorarioPadrao(0, idProfessor, diaSemana, horaInicio, horaFim, tipo);
        horarioPadraoDAO.inserir(horario);
        return "Horário padrão cadastrado.";
    }

    public String atualizarHorarioPadrao(int id, int idProfessor, String diaSemana, LocalTime horaInicio, LocalTime horaFim, String tipo) {
        HorarioPadrao horario = new HorarioPadrao(id, idProfessor, diaSemana, horaInicio, horaFim, tipo);
